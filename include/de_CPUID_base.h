...
#define DE_CIAX__MAX_IAX__MANUFAC_ID DE_CPUID_BASE_INFO(00)

/* Processor Info and Feature Bits */
#define DE_CIAX__PI__FT_BITS DE_CPUID_BASE_INFO(01)

/* Cache and TLB Descriptor Information */
#define DE_CIAX__CACHE__TLB DE_CPUID_BASE_INFO(02)

/* Processor Serial Number */
#define DE_CIAX__SERIAL_NR DE_CPUID_BASE_INFO(03)

/* Cache Hierarchy and Topology */
#define DE_CIAX__CACHE_H__TOPOLOGY_INTEL DE_CPUID_BASE_INFO(04)
#define DE_CIAX__CACHE_H__TOPOLOGY_AMD DE_CPUID_BASE_INFO_EXTENDED(1D)

/* Intel Thread/Core and Cache Topology */
#define DE_CIAX__CACHE_THREAD_CORE_TOPOLOGY_INTEL DE_CPUID_BASE_INFO(0B)

/* MONITOR/MWAIT Features */
#define DE_CIAX__MONITOR_MWAIT_FT DE_CPUID_BASE_INFO(05)

/* Thermal and Power Management */
#define DE_CIAX__THERMAL_POWER_MANAGEMENT DE_CPUID_BASE_INFO(06)
...
#define DE_CIAX___EX_FT_0 DE_CPUID_BASE_INFO(07), DE_CPUID_BASE_INFO(00)
#define DE_CIAX___EX_FT_1 DE_CPUID_BASE_INFO(07), DE_CPUID_BASE_INFO(01)
#define DE_CIAX___EX_FT_2 DE_CPUID_BASE_INFO(07), DE_CPUID_BASE_INFO(02)

/* XSAVE Features and State Components */
#define DE_CIAX__XSAVE_FT__STATE_COMPONENTS DE_CPUID_BASE_INFO(0D)

/* SGX Capabilities */
/* refer to "https://en.wikipedia.org/wiki/CPUID#EAX=12h:_SGX_Capabilities" for more information*/
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__SGX__leaf_funcs__MISCSELECT__MAX_SIZES DE_CPUID_BASE_INFO(12), DE_CPUID_BASE_INFO(00)
#define DE_CIAX__SGX__SETTABLE_BITS_SECATTRIBS          DE_CPUID_BASE_INFO(12), DE_CPUID_BASE_INFO(01)
#define DE_CIAX__SGX__ENCLAVE_PAGE_CACHE_SEC_INFO       DE_CPUID_BASE_INFO(12), DE_CPUID_BASE_INFO(02)

/* Processor Trace*/
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__PROCESSOR_TRACE DE_CPUID_BASE_INFO(14), DE_CPUID_BASE_INFO(0)

/*  CPU, TSC, Bus and Core Crystal Clock Frequencies */
/* TSC and Core Crystal frequency information */
#define DE_CIAX__TSC__CORE_CRYST_FREQ DE_CPUID_BASE_INFO(15)
/* Processor and Bus specification frequencies */
#define DE_CIAX__PROCESSOR_BUS_SPEC_FREQUENCIES DE_CPUID_BASE_INFO(16)

/* SoC Vendor Attribute Enumeration */
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__SOC_VENDOR_ATTRIBS DE_CPUID_BASE_INFO(17), DE_CPUID_BASE_INFO(0)

/* Intel Key Locker Features */
#define DE_CIAX__INTEL_KEY_LOCKER_FEATURES DE_CPUID_BASE_INFO(19)

/* Intel AMX Tile Information */
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__INTEL_AMX_TILE_INFO DE_CPUID_BASE_INFO(1D), DE_CPUID_BASE_INFO(01)

/* Intel AMX Tile Multiplier (TMUL) Information */
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__INTEL_AMX_TMUL_INFO         DE_CPUID_BASE_INFO(1E), DE_CPUID_BASE_INFO(00)
#define DE_CIAX__INTEL_AMX_TMUL_FEATURE_INFO DE_CPUID_BASE_INFO(1E), DE_CPUID_BASE_INFO(01)

/* AVX10 Converged Vector ISA */
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__AVX10_FT DE_CPUID_BASE_INFO(24), DE_CPUID_BASE_INFO(00)

/* Discrete AVX10 Features */
/* input as first argument in de_cpuid_call_ex or just go with de_cpuid_request*/
#define DE_CIAX__AVX10_DISCRETE_FT DE_CPUID_BASE_INFO(24), DE_CPUID_BASE_INFO(01)
...
#define DE_CIAX__MAX_EIAX DE_CPUID_BASE_INFO_EXTENDED(00)

/* Extended Processor Info and Feature Bits */
#define DE_CIAX__EX_PI__FT_BITS DE_CPUID_BASE_INFO_EXTENDED(01)

/* Processor Brand String */
/* https://en.wikipedia.org/wiki/CPUID#EAX=8000'0002h,8000'0003h,8000'0004h:_Processor_Brand_String */
#define DE_CIAX__P_BRAND_STR_0 DE_CPUID_BASE_INFO_EXTENDED(02)
#define DE_CIAX__P_BRAND_STR_1 DE_CPUID_BASE_INFO_EXTENDED(03)
#define DE_CIAX__P_BRAND_STR_2 DE_CPUID_BASE_INFO_EXTENDED(04)

/* L1 Cache and TLB Identifiers */
#define DE_CIAX__L1_CACHE__TLB_ID DE_CPUID_BASE_INFO_EXTENDED(05)

/* Extended L2 Cache Features */
#define DE_CIAX__L2_CACHE_EXTENDED DE_CPUID_BASE_INFO_EXTENDED(06)

/* Processor Power Management Information and RAS Capabilities */
#define DE_CIAX__P_POWER_MANAGEMENT__RAS_CAPABILITY DE_CPUID_BASE_INFO_EXTENDED(07)

/* Virtual and Physical Address Sizes */
#define DE_CIAX__SIZE_VIRTUAL_PHYSICAL_ADDRESS DE_CPUID_BASE_INFO_EXTENDED(08)

/* SVM_FEATURES */
#define DE_CIAX__SVM_FEATURES DE_CPUID_BASE_INFO_EXTENDED(0A)

/* Encrypted Memory Capabilities */
#define DE_CIAX__ENCR_MEM_CAPABILITY DE_CPUID_BASE_INFO_EXTENDED(1F)

/* Extended Feature Identification */
#define DE_CIAX__EXT_FT_ID DE_CPUID_BASE_INFO_EXTENDED(21)

/* AMD Easeter Eggs*/
#define DE_CIAX__AMD_EASTER_EGG_0 0x8FFFFFFE
#define DE_CIAX__AMD_EASTER_EGG_1 0x8FFFFFFF

/* Highest Centaur Extended Function */
#define DE_CIAX__CENTAUR_HIGHEST_EXT_FUNC 0xC0000000

/* Centaur Feature Information */
#define DE_CIAX__CENTAUR_FT_INFOR 0xC0000001

/* Helper Macros */
#define DE_INTERNAL_CPUID_CALL_GET(_1, _2, _3, NAME, ...) NAME

#define DE_CPUID_BASE_INFO(hex) 0x000000##hex
#define DE_CPUID_BASE_INFO_EXTENDED(hex) 0x800000##hex
/* END Helper Macros */
